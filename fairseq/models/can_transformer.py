...
@register_model('can_transformer')
class TransformerModel(FairseqModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--decoder-ev-embed-dim', type=int, metavar='N',
                            help='decoder encdec-attn v embedding dimension')
        # fmt: on
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def __init__(self, args, no_encoder_attn=False):
        ...
        if no_encoder_attn:
            ...
            self.encoder_attn = CompressedSublayer(
                self.embed_dim, args.decoder_attention_heads,
                args.decoder_ev_embed_dim,
...
@register_model_architecture('can_transformer', 'can_transformer')
...
@register_model_architecture('can_transformer', 'can_transformer_t2t_wmt_en_de_el12_dl2')
def transformer_t2t_wmt_en_de(args):
    args.encoder_normalize_before = True
    args.decoder_normalize_before = True
    args.attention_dropout = getattr(args, 'attention_dropout', 0.1)
    args.relu_dropout = getattr(args, 'relu_dropout', 0.1)
    args.decoder_ev_embed_dim = getattr(args, 'decoder_ev_embed_dim', 2048)
